...
sync-templates: ## Regenerate rusm-cli/templates/ — the vendored copy of the example apps the scaffolder ships
	@for lang in typescript rust go; do \
		rsync -a --delete \
			...
			examples/todo-board/$$lang/ rusm-cli/templates/$$lang/; \
	done
	...
	@# examples/weather-api/rust (renamed flat) plus the rusm:runtime guest WIT from rusm-rs.
	...
	@cp examples/weather-api/rust/src/main.rs                          rusm-cli/templates/weather/host-main.rs
	@cp examples/weather-api/rust/bridges/weather/bridge.wit           rusm-cli/templates/weather/bridge.wit
	@cp examples/weather-api/rust/bridges/weather/host.rs              rusm-cli/templates/weather/host.rs
	@cp examples/weather-api/rust/components/api/src/lib.rs            rusm-cli/templates/weather/rust-guest.rs
	@cp examples/weather-api/typescript/components/api/index.ts        rusm-cli/templates/weather/ts-guest.ts
	@cp examples/weather-api/go/components/api/main.go                 rusm-cli/templates/weather/go-guest.go
	@# (rusm-cli/templates/runtime-world.wit is a generated rusm:runtime guest world — it's a
	@# TARGETS entry in bridges/assemble-wit.sh, regenerated by `make sync-bridges`, not here.)
