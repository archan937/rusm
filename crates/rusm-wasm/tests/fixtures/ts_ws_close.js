...
// index.ts
var exports_ts_ws_close = {};
__export(exports_ts_ws_close, {
  default: () => ts_ws_close_default
});
module.exports = __toCommonJS(exports_ts_ws_close);
...
// index.ts
var ts_ws_close_default = websocket({
  message: (s) => {
    s.close(1000, "bye");
  }
});
