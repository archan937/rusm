...
```sh
rusm new myapp       # new project with a TypeScript HTTP component
cd myapp
...
```sh
rusm new myapp --protocol ws    # new project with a WebSocket component
rusm new myapp --protocol sse   # new project with an SSE component
```
