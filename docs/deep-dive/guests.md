...
`web.Handlers`; WebSocket and SSE are one process per connection ([`web.Sse`](/build-an-app/serve-sse)).
...
[capabilities](/deep-dive/permissions-and-sandboxing) and [preemption](/deep-dive/epoch-preemption)
