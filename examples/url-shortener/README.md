...
Every variant uses **published** dependency specs (`rusm-ts@^0.5.0`, `rusm-rs = "0.5.0"`,
`rusm-go@v0.5.0`) — copy any one directory out of the repo and it builds on its own.
