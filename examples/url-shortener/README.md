...
Every variant uses **published** dependency specs (`rusm-ts@^0.4.1`, `rusm-rs = "0.4.1"`,
`rusm-go@v0.4.1`) — copy any one directory out of the repo and it builds on its own.
