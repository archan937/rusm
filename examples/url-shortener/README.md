...
Every variant uses **published** dependency specs (`rusm-ts@^0.3.0`, `rusm-rs = "0.3.0"`,
`rusm-go@v0.3.0`) — copy any one directory out of the repo and it builds on its own.
